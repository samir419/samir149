class Test_character2 {
    constructor(x,y,direction){
       ...
       this.animation_state=0
        ...
        this.idle_right.src = 'assets/chara2/idle-right.png';
    
        this.move_right = [new Image(),new Image(),new Image()]
        this.move_right[0].src = 'assets/chara2/move-right-1.png';
        this.move_right[1].src = 'assets/chara2/move-right-2.png';
        this.move_right[2].src = 'assets/chara2/move-right-3.png';
    
        this.jump_right = new Image();
        this.jump_right.src = 'assets/chara2/jump-right.png';

        this.dash_right = new Image();
        this.dash_right.src = 'assets/chara2/run-right.png'

        this.jab_right = new Image();
        this.jab_right.src = 'assets/chara2/jab-right.png'

        this.hook_right = new Image()
        this.hook_right.src = 'assets/chara2/hook-right.png'

        this.swing_right = new Image()
        this.swing_right.src = 'assets/chara2/swing-right.png'


        this.idle_left = new Image();
        this.idle_left.src = 'assets/chara2/idle-left.png';
    
        this.move_left = [new Image(),new Image(),new Image()];
        this.move_left[0].src = 'assets/chara2/move-left-1.png';
        this.move_left[1].src = 'assets/chara2/move-left-2.png';
        this.move_left[2].src = 'assets/chara2/move-left-3.png';
    
        this.jump_left = new Image();
        this.jump_left.src = 'assets/chara2/jump-left.png';

        this.dash_left = new Image();
        this.dash_left.src = 'assets/chara2/run-left.png'

        this.jab_left = new Image();
        this.jab_left.src = 'assets/chara2/jab-left.png'

        this.hook_left = new Image()
        this.hook_left.src = 'assets/chara2/hook-left.png'

         this.swing_left = new Image()
        this.swing_left.src = 'assets/chara2/swing-left.png'

         this.block_ = new Image()
        this.block_.src = 'assets/chara2/block.png'

         this.knock_down = new Image()
        this.knock_down.src = 'assets/chara2/knockdown.png'

        this.hit = new Image()
        this.hit.src = 'assets/chara2/hit.png'
    }
    update(){
        if(this.dash_frames==1){
            this.dx = 0
        }
   ...
   move(movement_direction){
    ...
    hook(){
        if(this.state!='knockdown'&&this.state!='hit'){
            ...
            this.combo_window = 8
            this.hitbox.width = 110*this.direction
